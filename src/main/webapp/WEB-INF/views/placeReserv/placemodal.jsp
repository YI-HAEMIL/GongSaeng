...
<link rel="stylesheet" href="resources/myLib/placeCSS.css?ver=1.7" type="text/css">
				...
				geocoder.addressSearch(
						...
						function(result, status) {
							...
							var infowindow = new kakao.maps.InfoWindow({
								content : '<div style="width:150px;text-align:center;padding:6px 0;">${ppVO.place_nm}</div>'
								});
